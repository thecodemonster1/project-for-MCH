...
//==========================================End Functions============================================================
    ...
    private void initComponents() {
        ...
        kButton4.setkEndColor(new java.awt.Color(153, 153, 0));
        kButton4.setkHoverEndColor(new java.awt.Color(0, 204, 204));
        kButton4.setkHoverForeGround(new java.awt.Color(0, 0, 0));
        kButton4.setkHoverStartColor(new java.awt.Color(0, 255, 153));
        kButton4.setkStartColor(new java.awt.Color(102, 204, 0));
        ...
        kButton5.setkEndColor(new java.awt.Color(153, 153, 0));
        kButton5.setkHoverEndColor(new java.awt.Color(0, 204, 204));
        kButton5.setkHoverForeGround(new java.awt.Color(0, 0, 0));
        kButton5.setkHoverStartColor(new java.awt.Color(0, 255, 153));
        kButton5.setkStartColor(new java.awt.Color(102, 204, 0));
        ...
        kButton6.setkEndColor(new java.awt.Color(153, 153, 0));
        kButton6.setkHoverEndColor(new java.awt.Color(0, 204, 204));
        kButton6.setkHoverForeGround(new java.awt.Color(0, 0, 0));
        kButton6.setkHoverStartColor(new java.awt.Color(0, 255, 153));
        kButton6.setkStartColor(new java.awt.Color(102, 204, 0));
        ...
        kButton7.setkHoverEndColor(new java.awt.Color(0, 204, 204));
        kButton7.setkHoverForeGround(new java.awt.Color(0, 0, 0));
        kButton7.setkHoverStartColor(new java.awt.Color(0, 255, 153));
        kButton7.setkStartColor(new java.awt.Color(102, 204, 0));
        kButton7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kButton7ActionPerformed(evt);
            }
        });
        getContentPane().add(kButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 140, 109, -1));
